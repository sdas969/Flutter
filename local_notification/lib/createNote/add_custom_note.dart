...
class AddCustomNote extends StatefulWidget {
  const AddCustomNote({Key? key}) : super(key: key);

  @override
  State<AddCustomNote> createState() => _AddCustomNoteState();
}

class _AddCustomNoteState extends State<AddCustomNote> {
                            ...
                            Expanded(
                              child: Material(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: 'Enter Repeat Interval.',
                                      enabledBorder: OutlineInputBorder(
                                          borderSide: BorderSide.none,
                                          borderRadius:
